...
log_info ""
log_info "Next steps:"
log_info "  1. Run 15-nva-tests.sh to verify routing works"
log_info ""
log_info "Note: If VM was deployed with 07-vm.sh, nftables NAT is already configured."
log_info "      If not, or to update rules manually, run: 08-nftables.sh"
