...
run "test_valid_configurations" {
  ...
  variables {
    ...
    environment   = "dev"
    tenant_id     = null # Valid - null is allowed
  }

  # No expect_failures - these should all be valid values
  # Test validates that good inputs don't trigger validation errors
}
