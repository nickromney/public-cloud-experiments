#!/bin/bash
# Build deployment package for React Web App with Easy Auth
# For Easy Auth, we build WITHOUT hardcoded auth method to enable auto-detection
set -e
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Building Easy Auth deployment package for React Web App"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# Build frontend-react with Easy Auth auto-detection
echo "Building frontend-react with Easy Auth..."
cd "$FRONTEND_REACT_DIR"
npm install

# Build with only API_BASE_URL - auth method will auto-detect as 'easyauth' from hostname
VITE_API_BASE_URL="${API_BASE_URL:-https://func-subnet-calc-react-easyauth-e2e-api.azurewebsites.net}" \
npm run build
...
echo "   Auth Method: Easy Auth (auto-detected from *.azurewebsites.net hostname)"
echo "   API Base URL: ${API_BASE_URL:-https://func-subnet-calc-react-easyauth-e2e-api.azurewebsites.net}"
